namespace PhotoShare.Models
{
    ...
    public class User
    {
        ...
        //[Age] // throws exception because first its declared to be null and after that in validation check if its null throw an Exception so this validation is inconsistent
