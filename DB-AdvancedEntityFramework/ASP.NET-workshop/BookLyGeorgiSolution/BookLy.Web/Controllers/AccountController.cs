namespace BookLy.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Details(string id)
        {
            ...
            ApplicationUser user = this.UserManager.Users.Include(u => u.Books).SingleOrDefault(u => u.Id == id);
            if (user == null)
            {
                return this.HttpNotFound();
            }

            AccountDetailsViewModel userViewModel = Mapper.Instance.Map<AccountDetailsViewModel>(user);
            userViewModel.ProfilePictureBase64Url = "data:image; base64," + Convert.ToBase64String(user.ProfilePicture);
        ...
        {
            this.ViewBag.ReturnUrl = returnUrl ?? string.Empty;
            return this.View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                {
                    user.ProfilePicture = GetFileByteArray(model.ProfilePictureFile);
                }
        ...
        private static byte[] GetFileByteArray(HttpPostedFileBase modelProfilePicture)
        {
            MemoryStream stream = new MemoryStream();
            modelProfilePicture.InputStream.CopyTo(stream);
